...
class Graph():
    ...
    def display(self):
        print("V = {",end='\n')
        for x in range(len(self.vs)):
            print(str(x+1)+': '+str(self.vs[x]),end='\n')
        print("}",end='\n')
        print("E = {",end='\n')
        if len(self.es)!= 0:
            for x in range(len(self.es)-1):
                print('<'+str(self.coord2index(self.es[x].src)+1)+','+str(self.coord2index(self.es[x].dst)+1)+'>,',end='\n')
            print('<'+str(self.coord2index(self.es[-1].src)+1)+','+str(self.coord2index(self.es[-1].dst)+1)+'>',end='\n')
        print("}",end='\n')
